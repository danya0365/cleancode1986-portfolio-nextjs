    ...
    <div className="relative py-20 bg-gradient-to-b from-slate-50 to-white dark:from-gray-950 dark:to-gray-900 min-h-screen overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.h1
            variants={itemVariants}
            className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 mb-6 tracking-tight"
          >
            ทำความรู้จักกับเรา
          </motion.h1>
          <motion.p
          ...
          >
            ใช้ AI เขียนโค้ด + ควบคุมคุณภาพด้วย Clean Architecture — ส่งมอบเร็ว
            ราคาดี คุณภาพสูง
          </motion.p>
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
            <motion.div variants={itemVariants}>
              ...
              <div className="space-y-6 text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <p>
                  ...
                  ที่วางแผนมาอย่างรัดกุม — AI เขียนโค้ด เราควบคุมคุณภาพ
                  ประหยัดต้นทุน ส่งมอบเร็วกว่าเดิมหลายเท่า
                </p>
                <p>
                  ด้วยประสบการณ์กว่า 5 ปี + AI-Powered Workflow
                  เราไม่ได้เป็นแค่คนรับจ้างเขียนโค้ด
                  แต่เราคือสะพานเชื่อมระหว่างคุณ...และอนาคต
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative w-full aspect-square max-w-[400px] bg-gradient-to-br from-blue-500 to-indigo-600 rounded-[3rem] rotate-3 hover:rotate-0 transition-all duration-500 shadow-2xl flex items-center justify-center border-8 border-white dark:border-gray-800">
                <span
                  className="text-9xl filter drop-shadow-xl animate-bounce"
          ...
          {[
            {
              ...
              desc: "ใช้ AI พัฒนาซอฟต์แวร์คุณภาพระดับ Enterprise ในราคาที่เข้าถึงได้ ลูกค้าประหยัดต้นทุน 80%+",
            },
            {
              icon: "👁️",
              title: "วิสัยทัศน์ (Vision)",
              desc: "เป็น Digital Agency อันดับหนึ่งสำหรับธุรกิจที่ต้องการเว็บคุณภาพสูง ราคาดี — AI-Powered + Human Expertise",
            },
            {
              icon: "💎",
              title: "ค่านิยม (Core Values)",
              desc: "AI Code Generation + Clean Architecture Quality Control, ซื่อสัตย์โปร่งใส, ส่งมอบเร็ว ราคาดี",
            },
          ].map((item, idx) => (
            <motion.div
              key={idx}
        ...
        >
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              AI-Powered Development + Clean Architecture — ประหยัดกว่าจ้างทีม
              ส่งมอบเร็วกว่าเดิม
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "ใช้ AI Code Generation สร้างโค้ดคุณภาพสูง เร็วกว่าเขียนเองหลายเท่า",
              },
              {
                icon: "�️",
                title: "Clean Architecture",
                description:
                  "ทุกโปรเจคใช้ Clean Architecture Pattern — รองรับการขยายตัวในอนาคต",
              },
              {
                icon: "�",
                title: "Cost-Effective",
                description:
                  "ประหยัดต้นทุน 80%+ กว่าจ้างทีม Developer 3 คน เหมาะกับ SME และ Startup",
              },
              {
                icon: "⚡",
                title: "Blazing Fast Delivery",
                description:
                  "ส่งมอบเร็วกว่าเดิม 5 เท่า ด้วย AI Workflow + Human Quality Control",
              },
              {
                icon: "�",
                title: "Modern Tech Stack",
                description:
                  "Next.js 15, React, Supabase — เทคโนโลยีล้ำสมัยที่สุดในตลาด",
              },
              {
                icon: "�",
                title: "Premium Quality",
                description:
                  "AI Code + Human Review ผสานพลัง AI กับความเชี่ยวชาญของเรา",
              },
            ].map((item, idx) => (
              <motion.div
                key={idx}
        ...
        <div className="mb-24 relative">
          ...
          >
            ...
            <motion.h3
              variants={itemVariants}
              className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 mb-6 tracking-tight"
            >
            ...
            >
              ...
              เข้ากับความรวดเร็วของ{" "}
              <b className="text-indigo-600 dark:text-indigo-400">
                ปัญญาประดิษฐ์ (AI Agents)
              </b>{" "}
              เพื่อทลายทุกข้อจำกัดและเสกงานให้เสร็จสมบูรณ์ระดับเทพ
              ไวและเนียบกว่าใคร
            </motion.p>
          </motion.div>
                      ...
                      <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                        {member.linkedinUrl && (
                          <a
                            ...
                            className="flex items-center gap-3 px-6 py-3 bg-white/10 hover:bg-[#0077b5] rounded-xl text-white font-bold transition-all backdrop-blur hover:shadow-lg hover:shadow-[#0077b5]/30 hover:-translate-y-1"
                          >
                            LinkedIn
                          </a>
                        )}
                        {member.githubUrl && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-3 px-6 py-3 bg-white/10 hover:bg-black rounded-xl text-white font-bold transition-all backdrop-blur hover:shadow-lg hover:shadow-black/30 hover:-translate-y-1"
                          >
                            GitHub
                          </a>
                        )}
