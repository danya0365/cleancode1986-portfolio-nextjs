    ...
    <div className="flex flex-col gap-12 p-4 sm:p-8 lg:p-12 pb-32">
      ...
      <div>
        ...
        <p className="mt-8 text-xl sm:text-2xl font-black uppercase max-w-3xl bg-black text-white px-4 py-2 inline-block -rotate-1 shadow-[8px_8px_0_0_#FF00FF]">
          ใช้ AI เขียนโค้ด + ควบคุมคุณภาพด้วย Clean Architecture
        </p>
      </div>
      ...
      <RetroCard
        shadowSize="lg"
        borderSize="lg"
        className="bg-white p-8 sm:p-16 flex flex-col lg:flex-row gap-12 mt-8 items-center bg-[url('https://grainy-gradients.vercel.app/noise.svg')]"
      >
        <div className="lg:w-1/2">
          <RetroHeading className="mb-8" bg="lime">
            จุดเริ่มต้นของเรา
          </RetroHeading>
          <p className="font-bold text-lg leading-relaxed mb-6 uppercase border-l-8 border-black pl-6">
            <span className="text-[#FF00FF] font-black">Clean Code 1986</span>{" "}
          ...
          <p className="font-bold text-lg leading-relaxed mb-6 uppercase border-l-8 border-[#00FFFF] pl-6">
            เราผสานพลัง AI เข้ากับ Clean Architecture — AI เขียนโค้ด
            เราควบคุมคุณภาพ ประหยัดต้นทุน ส่งมอบเร็วกว่าเดิมหลายเท่า
          </p>
          <p className="font-black text-2xl uppercase border-4 border-black p-4 shadow-[4px_4px_0_0_readonly]">
            ...
            เราคือสะพานเชื่อมระหว่างคุณและอนาคต
          </p>
        </div>
        <div className="lg:w-1/2 flex justify-center">
          <div className="w-64 h-64 bg-[#39FF14] rounded-full border-8 border-black flex items-center justify-center shadow-[16px_16px_0_0_#FF00FF] transform rotate-12">
            <span className="text-[120px] filter grayscale hover:grayscale-0 transition-all duration-300">
              💻
            </span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
        {[
          ...
          },
          {
            ...
            desc: "เป็น Digital Agency อันดับหนึ่งสำหรับธุรกิจที่ต้องการเว็บคุณภาพสูง ราคาดี — AI-Powered + Human",
            color: "cyan",
          },
          {
            icon: "💎",
          ...
          <RetroCard
            ...
            shadowSize="md"
            hoverEffect
            className="p-8 text-center flex flex-col items-center group bg-white"
          >
            ...
            <RetroBadge
              color={item.color as "magenta" | "cyan" | "lime"}
      ...
      <div className="mt-24 mb-12 flex flex-col items-center">
        <RetroBadge color="white" variant="skew" className="mb-4 text-lg">
          THE DIGITAL WORKFORCE
        </RetroBadge>
        <RetroHeading bg="magenta" className="text-center">
        ...
        <p className="mt-8 font-black uppercase text-xl max-w-3xl text-center bg-black text-white p-4">
          เทคโนโลยีที่ดีสุด เกิดจากการทำงานร่วมกันของ{" "}
          <span className="text-[#39FF14]">มนุษย์ (HUMAN)</span> และ{" "}
          <span className="text-[#00FFFF]">ปัญญาประดิษฐ์ (AI)</span>
        </p>
      </div>
        ...
        {team
          ...
          .map((member) => (
            <RetroCard
              ...
              borderSize="lg"
              shadowSize="lg"
              className="bg-[#00FFFF] p-8 sm:p-12 border-l-[16px] border-black"
            >
              <div className="flex flex-col lg:flex-row gap-12 items-center">
                <div className="w-64 h-64 border-8 border-black bg-white shrink-0 relative p-2 shadow-[8px_8px_0_0_#FF00FF] transform -rotate-3 hover:rotate-0 transition-transform">
                  <Image
                    ...
                    alt={member.name}
                    fill
                    className="object-cover p-2 grayscale hover:grayscale-0 transition-all duration-300"
                  />
                </div>
                <div className="flex-1 text-center lg:text-left">
                  ...
                  <h3 className="text-5xl font-black uppercase mb-2 text-black">
                    {member.name}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                    ...
                    {member.githubUrl && (
                      <RetroButton href={member.githubUrl} variant="primary">
                        GitHub
                      </RetroButton>
                    )}
                    {member.hasCV && (
        ...
        {team
          ...
          .map((member) => (
            <RetroCard
              ...
              borderSize="md"
              shadowSize="md"
              className="bg-[#FF00FF] p-6 text-white flex flex-col"
            >
              <div className="flex justify-between items-start mb-6 border-b-8 border-black pb-6">
                ...
                <RetroBadge color="white" className="text-xs">
                  AI AGENT ✨
                </RetroBadge>
              </div>
      ...
      {SITE.hiring.isHiring && (
        <RetroCard
          borderSize="lg"
          shadowSize="lg"
          className="bg-[#39FF14] text-black p-8 sm:p-16 text-center mt-24"
        >
          <RetroHeading
            bg="white"
            className="border-b-8 border-black mb-8 px-4 inline-block"
          >
            JOIN THE AI REVOLUTION
          </RetroHeading>
          <h2 className="text-4xl sm:text-5xl font-black mb-6 uppercase leading-tight">
            อยากเป็นส่วนหนึ่งของ AI-Powered Team?
          </h2>
          <p className="text-xl font-bold mb-12 max-w-2xl mx-auto uppercase bg-white p-4 border-4 border-black">
            เรากำลังเปิดรับคนเก่งๆ ไฟแรง ที่หลงใหลใน AI + Clean Architecture
            และอยากเติบโตไปพร้อมกับเรา
          </p>
