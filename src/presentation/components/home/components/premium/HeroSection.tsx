...
import { HERO } from "@/src/data/master/hero";
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center px-4 py-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur border border-blue-100 dark:border-blue-900/50 text-blue-600 dark:text-blue-400 rounded-full text-sm font-bold mb-8 shadow-sm"
            >
              <span className="mr-2 animate-pulse">{HERO.badge.icon}</span>
            ...
            <motion.h1
              variants={fadeUpVariant}
              className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-gray-900 dark:text-white mb-6 tracking-tight"
            >
            ...
            >
              ...
              >
                ...
                <span className="relative">{HERO.cta.primary.text}</span>
              </Link>
              <Link
