...
export function RetroCTASection() {
  ...
  return (
    <RetroCard
      borderSize="lg"
      shadowSize="lg"
      className="bg-[#FF00FF] p-8 sm:p-16 text-center relative overflow-hidden"
    >
      {/* Decorative Elements */}
      <div className="absolute top-10 left-10 text-6xl opacity-50 transform -rotate-12 select-none pointer-events-none mix-blend-overlay">
        💬
      </div>
      <div className="absolute bottom-10 right-10 text-6xl opacity-50 transform rotate-12 select-none pointer-events-none mix-blend-overlay">
        ⚡
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center">
        <h2 className="text-4xl sm:text-6xl lg:text-7xl font-black text-black uppercase tracking-tighter mb-6 leading-tight flex flex-col items-center gap-4">
          ...
          <span
            className="text-white styling-stroke"
            style={{
              WebkitTextStroke: "2px black",
              textShadow: "4px 4px 0px #00FFFF",
            }}
          >
            ราคาดีหรือยัง?
          </span>
        ...
        <p className="text-lg sm:text-2xl font-bold bg-black text-white p-4 inline-block mb-12 shadow-[6px_6px_0_0_#00FFFF] sm:shadow-[8px_8px_0_0_#00FFFF] rotate-1">
          ปรึกษาฟรี ไม่มีค่าใช้จ่าย — AI-Powered Development
        </p>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-stretch gap-6 w-full max-w-3xl border-4 border-black bg-white p-6 shadow-[8px_8px_0_0_#000]">
          ...
          >
            <span className="group-hover:animate-bounce">⚡</span> ปรึกษาฟรีเลย
          </button>

          <RetroButton
            href="/promo"
            variant="white"
            className="sm:flex-none border-4 sm:border-[6px] py-4 px-6 text-xl shadow-[6px_6px_0_0_rgba(0,0,0,1)] hover:shadow-[2px_2px_0_0_rgba(0,0,0,1)]"
          >
            ดูราคาบริการ
          </RetroButton>
        </div>
