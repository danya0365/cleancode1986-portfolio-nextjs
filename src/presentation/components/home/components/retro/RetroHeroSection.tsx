...
export function RetroHeroSection() {
  return (
    <RetroCard borderSize="lg" shadowSize="lg" className="relative p-8 sm:p-16 bg-[#Fdfdf5] z-0">
      ...
      <div className="absolute inset-x-0 inset-y-0 overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute inset-0 opacity-[0.25] mix-blend-multiply" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.8' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)'/%3E%3C/svg%3E")` }}></div>
        ...
        <div className="absolute top-[10%] left-[80%] font-black text-4xl sm:text-8xl text-black select-none opacity-40 sm:opacity-80">+</div>
        <div className="absolute bottom-[10%] left-[10%] font-black text-4xl sm:text-6xl text-black select-none opacity-40 sm:opacity-80">*</div>
        <div className="absolute top-[50%] right-[5%] font-black text-4xl sm:text-6xl text-black select-none opacity-40 sm:opacity-80 rotate-45">~</div>
      </div>
      {/* --- End Playful Background Overlay --- */}

      <RetroBadge variant="skew" color="magenta" className="absolute -top-6 -left-6 z-20">
        ISSUE #01
      </RetroBadge>
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black uppercase leading-tight tracking-tighter mb-8 flex flex-col items-start gap-2 sm:gap-3">
          ...
          <span className="flex flex-wrap items-center gap-2 sm:gap-4 mt-2">
            ...
            <span 
              ...
              style={{ WebkitTextStroke: '2px black', textShadow: '3px 3px 0 #FF00FF' }}
            >
              แอปพลิเคชัน
            </span>
          </span>
