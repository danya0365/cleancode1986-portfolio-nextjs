    ...
    <section className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {testimonials.map((testimonial, i) => (
          ...
          >
            <div className="absolute -top-5 -right-5 text-6xl opacity-20 font-serif">
              &quot;
            </div>
            ...
            <div className="flex items-center gap-4 border-t-4 border-black pt-4">
              <div
                className={`w-12 h-12 flex items-center justify-center font-black text-xl border-4 border-black ${i % 2 === 0 ? "bg-[#39FF14]" : "bg-[#00FFFF]"}`}
              >
